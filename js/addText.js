function addText(module) {
	...
	module.storyBoxContents = [
        ...
        "Cas9 can be considered as the molecular scissors that cut DNA, the gRNA serves as the targeting system for Cas9. Inside the cell, the gRNA binds to Cas9 and thus renders Cas9 highly selective for it's target DNA. Upon binding, <a href='http://science.sciencemag.org/content/348/6242/1477' target='blank'>Cas9 changes it's conformation</a> to accomodate the gRNA, which also converts the inactive protein to it's active state.",
        ...
        "Many scientists believe that gene editing is the just <a href='http://www.nature.com/news/crispr-gene-editing-is-just-the-beginning-1.19510' target='blank'>the first step towards harnessing the power of CRISPR.</a> <br><br>" +
