function addText(module) {
	...
	module.storyBoxContents = [
        ...
        "While Cas9 can be considered as the molecular scissors that cut DNA, the gRNA serves as the targeting system for Cas9. Inside the cell, the gRNA binds to Cas9 and thus renders Cas9 highly selective for it's target DNA. Upon binding, <a href='http://science.sciencemag.org/content/348/6242/1477' target='blank'>Cas9 changes it's conformation</a> to accomodate the gRNA, which also converts the inactive protein to it's active state.",
        ...
        "Transport into the nucleus occurs via a <a href='http://pdb101.rcsb.org/motm/205' target='blank' class ='nucleus'>nuclear pore complex</a>.",

        "Inside the nucleus, Cas9 needs to locate it's <span class='dna1'>t</span><span class='dna2'>a</span><span class='dna1'>r</span><span class='dna2'>g</span><span class='dna1'>e</span><span class='dna2'>t</span> <span class='dna1'>D</span><span class='dna2'>N</span><span class='dna1'>A</span>.",
        ...
        "The PAM sequence on the target DNA binds to <span class='pamdomain'>the PAM-interacting domain (light blue)</span> on Cas9. Initial binding of the target DNA to Cas9 is accompanied by <a href='http://science.sciencemag.org/content/351/6275/867' target='blank'>another conformational change in Cas9</a>.",
        ...
        "Many scientists believe that gene editing is the just <a href='http://www.nature.com/news/crispr-gene-editing-is-just-the-beginning-1.19510' target='blank'>the first step in harnessing the power of CRISPR.</a> <br><br>" +
        "<a href='http://www.samhertig.com' class='credits'>© 2017 by Hertig Visualizations</a>"
